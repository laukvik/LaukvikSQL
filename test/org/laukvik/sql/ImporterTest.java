...
public class ImporterTest {
    ...
    public static File getTestFolder() {
        ClassLoader classLoader = ImporterTest.class.getClassLoader();
    ...
    public void read() throws Exception {
        DatabaseConnection db = DatabaseConnection.read("testpg");
        Importer importer = new Importer(db);
        importer.importCSV( ImporterTest.getTestFolder(), "employee");
    }
