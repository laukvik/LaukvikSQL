...
public class Exporter {
    ...
    public void exportTablesAsCSV(File directory) throws IOException, SQLException, DatabaseConnectionNotFoundException {
    ...
    public void backup(String... tables){
        ...
        try {
            ...
            for (Table t : s.getTables()){
                //System.out.println("Backing up " + t.getName());
            }
    ...
    /**
     * title        type            size    allownulls primary     foreign autoincrement, autogenerated, default,comments
     * id           int
     * name         varchar
     ...
     * @param file
     */
    public void createMetaData(Table table, File file) throws IOException {
    ...
    public static CSV createMetaDataCSV(Table table){
        ...
        System.out.println( csv.getMetaData().getColumnCount() );
        ...
        for (Column c : table.getColumns()){
            ...
            r.setValue( 5, (c.getForeignKey() == null ? "" : c.getForeignKey().getTable() + "(" + c.getForeignKey().getColumn() + ")") );
